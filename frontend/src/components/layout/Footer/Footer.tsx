      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300">Your flexible car subscription service for modern mobility needs.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#plans" className="text-gray-300 hover:text-accent transition-colors">Plans</Link></li>
